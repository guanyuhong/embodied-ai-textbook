...
本章配图优先使用 Mermaid 源图，后续可导出 SVG。源文件放在 `figures/ch01/` 下。
...
| 图 1-2 | 具身智能的感知-规划-行动-反馈闭环 | 流程图 | 建立全书核心框架 | 6.2 节 | `figures/ch01/fig1-2_embodied_loop.mmd` |
| 图 1-3 | 具身智能、机器人与 AI Agent 的关系 | 关系图 | 做概念辨析 | 4 节 | `figures/ch01/fig1-3_robot_agent_embodied_relation.mmd` |
